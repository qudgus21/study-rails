class CommentController < ApplicationController
  ...
  def write
    ...
    raise Error:: BadRequest unless ApplicationHelper.check_not_nil_all(params[:creator], params[:content])
  ...
  #댓글 수정
  def update
    raise Error::BadRequest unless ApplicationHelper.is_number(params[:comment_id])
